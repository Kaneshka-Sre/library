...
static int current_user_index;
    public static void main(String[] args){
        ...
        admin_mail_id.add("kaneshkasre@gmail.com");
        admin_password.add(7890);
        admin_mail_id.add("20csl03@kpriet.ac.in");
        admin_password.add(8987);
        
        learner_id.add(2000);
        learner_user_id.add("kaneshka");
        learner_deposit.add(1234);
        learner_password.add(4567);
        
        book_type.add("Nonfiction Books");
        book_name.add("Everything Started As Nothing");
        book_id.add(200);
        book_count.add(10);
        book_price.add(1250);

        book_type.add("Fiction Books");
        book_name.add("Two States");
        book_id.add(201);
        book_count.add(15);
        book_price.add(850);        

        book_type.add("Food");
        book_name.add("Tender At The Bone");
        book_id.add(202);
        book_count.add(9);
        book_price.add(850);     

        book_type.add("History");
        book_name.add("History Of Modern India");
        book_id.add(203);
        book_count.add(13);
        book_price.add(1850);

        book_type.add("Memoir");
        book_name.add("The Glass Castel");
        book_id.add(204);
        book_count.add(8);
        book_price.add(2000);

        book_type.add("Politics");
        book_name.add("Wings Of Fire");
        book_id.add(205);
        book_count.add(8);
        book_price.add(1580);
        Welcome();
